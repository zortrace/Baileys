...
// part so the check is invariant to @c.us â†” @s.whatsapp.net normalization.
const BOT_PHONE_REGEX = /^1313555\d{4}$|^131655500\d{2}$/;
/**
 * Mirrors WA Web's `Wid.isRegularUser()` (user âˆ§ Â¬PSA âˆ§ Â¬Bot). Used to gate tctoken
 * storage against malformed notifications â€” WA Web filters server-side but we
...
/** Build a SignalDataSet fragment that writes the merged index (persisted âˆª added) under the sentinel key. */
