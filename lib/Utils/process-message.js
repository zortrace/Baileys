...
const processMessage = async (message, { shouldProcessHistoryMsg, placeholderResendCache, ev, creds, signalRepository, keyStore, logger, options, getMessage }) => {
    ...
    if (protocolMsg) {
        ...
        // the protocol message types that originate from our own device â€” an
        ...
        //
        // Cross-user types (must NOT be dropped â€” legitimately arrive from others):
        //   - REVOKE
        //   - MESSAGE_EDIT
        //   - EPHEMERAL_SETTING
        ...
        // for the reference architecture â€” whatsmeow's `handleProtocolMessage`
